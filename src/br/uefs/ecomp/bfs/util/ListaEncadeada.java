...
public class ListaEncadeada implements ILista{
    ...
    public Object recupera(int index) {
        if(estaVazia() || index > tamanho()){
            ...
            Iterador apontador = new iterador(); 
            Object celulaRecuperada = null;
            for(int i = 0; i <= index; i++){
                celulaRecuperada = apontador.proximo();
            }
            return celulaRecuperada;
        }
    }
    /**
    ...
    public class iterador implements Iterador {
